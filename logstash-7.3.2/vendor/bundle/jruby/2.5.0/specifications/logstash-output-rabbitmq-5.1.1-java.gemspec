...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<logstash-mixin-rabbitmq_connection>.freeze, [">= 5.0.0", "< 6.0.0"])
      ...
      s.add_dependency(%q<logstash-mixin-rabbitmq_connection>.freeze, [">= 5.0.0", "< 6.0.0"])
