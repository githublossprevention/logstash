# -*- encoding: utf-8 -*-
# stub: logstash-filter-prune 3.0.3 ruby lib

Gem::Specification.new do |s|
  s.name = "logstash-filter-prune".freeze
  s.version = "3.0.3"
  ...
  s.summary = "Prunes event data based on a list of fields to blacklist or whitelist".freeze
